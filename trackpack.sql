...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2020 a las 01:28:44
...
CREATE TABLE `clientes` (
  ...
  `verificado` varchar(6) DEFAULT NULL,
...
--
ALTER TABLE `curriers`
  MODIFY `idCurrier` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `cargas` CHANGE `idEstado` `idEstado` INT(11) NOT NULL DEFAULT '1';


/*Campo verificado debe ser boolean*/
